...
export default function StoreBadge({
      ...
      case "taptap":
        return (
          <div className="w-5 h-5 bg-[#00cccc] flex items-center justify-center rounded-sm">
            <span className="text-white font-bold text-[10px] leading-none mb-[1px]">
              T
            </span>
          </div>
        );
  ...
  const getLabel = () => {
    switch (platform) {
      case "steam":
        return "Get it on Steam";
      case "itch":
        return "Available on itch.io";
      case "taptap":
        return "Play on TapTap";
      default:
        return "Play Now";
    }
  };
  ...
  return (
    ...
    >
      ...
      {/* Active Border Glow */}
      <div
        className="absolute bottom-0 left-0 h-[2px] bg-white w-0 group-hover:w-full transition-all duration-500"
