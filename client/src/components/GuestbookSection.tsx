...
export default function GuestbookSection() {
  ...
  return (
    <section
      id="guestbook"
      className="py-24 md:py-32 bg-cream relative border-t-4 border-wood-dark overflow-hidden"
    >
            ...
            <div className="flex gap-4 items-center justify-center font-pixel text-xs text-wood-dark bg-yellow-400/20 border-2 border-wood border-dashed px-6 py-3 shadow-sm rounded-sm">
              <div className="flex items-center gap-2">
                ...
                <span
                  ...
                  className="font-bold text-coral ml-1"
                >
                  ...
                </span>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <FadeInView delay={100} className="w-full">
            <div className="wood-panel p-6 bg-wood relative">
              ...
              <h3 className="font-pixel text-cream mb-6 text-sm tracking-widest">
                写下你的留言
              </h3>
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div>
                  <label className="block font-pixel text-[10px] text-cream/80 mb-2 uppercase">
                    您的昵称
                  </label>
                  <input
                    type="text"
          ...
          <FadeInView
            delay={200}
            className="w-full flex-1 flex flex-col h-[400px]"
          >
            <div className="h-full overflow-y-auto pr-4 space-y-4 custom-scrollbar">
              {messages.map((msg, i) => (
                <div
                  key={msg.id}
                  className="parchment-panel p-5 relative animate-fade-in-up"
